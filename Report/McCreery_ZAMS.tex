...
The code used for this project can be found at the Github repository BLANK. A machine readable table with various parameters at select mass coordinates can be found in Table \ref{tab:MRT} on page 7.
